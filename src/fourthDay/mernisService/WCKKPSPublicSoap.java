...
public class WCKKPSPublicSoap
{
    ...
    public WCKKPSPublicSoap(){}

    public WCKKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public WCKKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        WCKExtendedSoapSerializationEnvelope envelope= new WCKExtendedSoapSerializationEnvelope(WCKExtendedSoapSerializationEnvelope.VER11);
