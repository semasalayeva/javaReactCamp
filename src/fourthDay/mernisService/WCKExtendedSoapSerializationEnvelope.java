...
public class WCKExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(WCKDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new WCKStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static WCKDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static WCKDateTimeConverter dateTimeConverter = new WCKStandardDateTimeConverter();

    public WCKExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public WCKExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new WCKMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=WCKHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,WCKExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=WCKHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
